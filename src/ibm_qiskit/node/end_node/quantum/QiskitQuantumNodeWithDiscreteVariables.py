...
# Class of the IBM Qiskit's Quantum Node with Discrete Variables
class QiskitQuantumNodeWithDiscreteVariables:

    # Constructor of the IBM Qiskit's Quantum Node with Discrete Variables
    def __init__(self, quantum_node_with_discrete_variables_id):

        # The ID of the IBM Qiskit's Quantum Node with Discrete Variables
        self.quantum_node_with_discrete_variables_id = quantum_node_with_discrete_variables_id

        # The Tag of the Type of the IBM Qiskit's Quantum Node,
        # with Discrete Variables
        self.quantum_node_with_discrete_variables_type_tag = \
            NodeTypes.QUANTUM_NODE_DISCRETE_VARIABLES_ENUM

        # The Owner Client Party of the IBM Qiskit's Quantum Node with Discrete Variables
        self.owner_client_party = None

        # The Boolean Flag, to keep the information about
        # the IBM Qiskit's Quantum Node with Discrete Variables is
        # currently being owned by some Client/Party
        self.owned_by_client_party = False

        # The Memory Hardware Module of the IBM Qiskit's Quantum Node with Discrete Variables
        self.memory_hardware_module = \
            QiskitMemoryModule.QiskitMemoryModule(MemoryModuleTypes.QUANTUM_MEMORY_ENUM)

        # The Communication Hardware Interface of the IBM Qiskit's Quantum Node with Discrete Variables
        ...
        # The Data/Information Bus Module of the IBM Qiskit's Quantum Node, for Discrete Variables
    ...
    # Attach some Owner Client Party to the IBM Qiskit's Quantum Node with Discrete Variables
    def attach_owner_client_party(self, owner_client_party):

        # Set the Owner Client Party of the IBM Qiskit's Quantum Node with Discrete Variables,
        # as the one given by argument
        self.owner_client_party = owner_client_party

        # Set the Boolean Flag, to keep the information about
        # the IBM Qiskit's Quantum Node with Discrete Variables
        # is currently being owned by some Client/Party, as True
        self.owned_by_client_party = True

    # Release the current Owner Client Party from the IBM Qiskit's Quantum Node with Discrete Variables
    def release_owner_client_party(self):

        # Set the Owner Client Party of the IBM Qiskit's Quantum Node with Discrete Variables, as None
        self.owner_client_party = None
    ...
    # Return the ID of the IBM Qiskit's Quantum Node with Discrete Variables
    def get_quantum_node_with_discrete_variables_id(self):
        return self.quantum_node_with_discrete_variables_id

    # Return the Tag of the Type of the IBM Qiskit's Quantum Node with Discrete Variables
    def get_quantum_node_with_discrete_variables_type_tag(self):
        return self.quantum_node_with_discrete_variables_type_tag

    # Return the Owner Client Party, using the IBM Qiskit's Quantum Node with Discrete Variables
    def get_owner_client_party(self):
        return self.owner_client_party

    # Return the Boolean Flag, to keep the information about
    # the IBM Qiskit's Quantum Node with Discrete Variables is currently being owned by some Client/Party
    def is_owned_by_client_party(self):
        return self.owned_by_client_party

    # Return the Memory Hardware Module of the IBM Qiskit's Quantum Node with Discrete Variables
    def get_memory_hardware_module(self):
        return self.memory_hardware_module

    # Return the Communication Hardware Interface of the IBM Qiskit's Quantum Node with Discrete Variables
    ...
    # Print the information about the IBM Qiskit's Quantum Node, with Discrete Variables
    def print_info(self):
        ...
        # Print the Heading, with the ID of the IBM Qiskit's Quantum Node, with Discrete Variables
        print("  Node #{}:\n".format(self.quantum_node_with_discrete_variables_id))

        # Print the Sub-Heading, for the Owner Client/Party
        print("   - Owner Client/Party:")

        # If the IBM Qiskit's Quantum Node, with Discrete Variables, is owned by some Client/Party
        ...
        # If the IBM Qiskit's Quantum Node, with Discrete Variables, is not owned by some Client/Party
        else:
        ...
        # Print the Tag of the Type of the IBM Qiskit's Quantum Node, with Discrete Variables
        print("   - Node's Type Tag: {};".format(self.get_quantum_node_with_discrete_variables_type_tag()))
