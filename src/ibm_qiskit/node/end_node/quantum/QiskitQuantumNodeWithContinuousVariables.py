...
# Class of the IBM Qiskit's Quantum Node with Continuous Variables
class QiskitQuantumNodeWithContinuousVariables:

    # Constructor of the IBM Qiskit's Quantum Node with Continuous Variables
    def __init__(self, quantum_node_with_continuous_variables_id):
        ...
        # the IBM Qiskit's Quantum Node with Continuous Variables is
        # currently being owned by some Client/Party
        self.owned_by_client_party = False

        # The Memory Hardware Module of the IBM Qiskit's Quantum Node with Continuous Variables
        self.memory_hardware_module = \
            QiskitMemoryModule.QiskitMemoryModule(MemoryModuleTypes.QUANTUM_MEMORY_ENUM)

        # The Communication Hardware Interface of the IBM Qiskit's Quantum Node with Continuous Variables
        ...
        # The Data/Information Bus Module of the IBM Qiskit's Quantum Node, for Continuous Variables
    ...
    # Attach some Owner Client Party to the IBM Qiskit's Quantum Node with Continuous Variables
    def attach_owner_client_party(self, owner_client_party):

        # Set the Owner Client Party of the IBM Qiskit's Quantum Node with Continuous Variables,
    ...
    # Release the current Owner Client Party from the IBM Qiskit's Quantum Node with Continuous Variables
    def release_owner_client_party(self):

        # Set the Owner Client Party of the IBM Qiskit's Quantum Node with Continuous Variables, as None
        self.owner_client_party = None
    ...
    # the IBM Qiskit's Quantum Node with Continuous Variables is currently being owned by some Client/Party
    def is_owned_by_client_party(self):
        return self.owned_by_client_party

    # Return the Memory Hardware Module of the IBM Qiskit's Quantum Node with Continuous Variables
    def get_memory_hardware_module(self):
        return self.memory_hardware_module

    # Return the Communication Hardware Interface of the IBM Qiskit's Quantum Node with Continuous Variables
    ...
    def print_info(self):
        ...
        # Print the Heading, with the ID of the IBM Qiskit's Quantum Node, with Continuous Variables
        print("  Node #{}:\n".format(self.quantum_node_with_continuous_variables_id))

        # Print the Sub-Heading, for the Owner Client/Party
        print("   - Owner Client/Party:")

        # If the IBM Qiskit's Quantum Node, with Continuous Variables, is owned by some Client/Party
        ...
        # If the IBM Qiskit's Quantum Node, with Continuous Variables, is not owned by some Client/Party
        else:
