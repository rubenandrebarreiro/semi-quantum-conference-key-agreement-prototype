...
class QiskitHybridNodeWithDiscreteVariables:

    # Constructor of the IBM Qiskit's Hybrid Node with Discrete Variables
    def __init__(self, hybrid_node_with_discrete_variables_id):

        # The ID of the IBM Qiskit's Hybrid Node with Discrete Variables
        self.hybrid_node_with_discrete_variables_id = hybrid_node_with_discrete_variables_id

        # The Tag of the Type of the IBM Qiskit's Hybrid Node,
        # with Discrete Variables
        self.hybrid_node_with_discrete_variables_type_tag = \
            NodeTypes.HYBRID_NODE_DISCRETE_VARIABLES_ENUM

        # The Owner Client Party of the IBM Qiskit's Hybrid Node with Discrete Variables
        self.owner_client_party = None

        # The Boolean Flag, to keep the information about
        # the IBM Qiskit's Hybrid Node with Discrete Variables is
        # currently being owned by some Client/Party
        self.owned_by_client_party = False

        # The Memory Hardware Module of the IBM Qiskit's Hybrid Node with Discrete Variables
        self.memory_hardware_module = \
            QiskitMemoryModule.QiskitMemoryModule(MemoryModuleTypes.HYBRID_MEMORY_ENUM)

        # The Communication Hardware Interface of the IBM Qiskit's Hybrid Node with Discrete Variables
    ...
    def attach_owner_client_party(self, owner_client_party):
        ...
        # Set the Owner Client Party of the IBM Qiskit's Hybrid Node with Discrete Variables,
    ...
    # Release the current Owner Client Party from the IBM Qiskit's Hybrid Node with Discrete Variables
    def release_owner_client_party(self):

        # Set the Owner Client Party of the IBM Qiskit's Hybrid Node with Discrete Variables, as None
        self.owner_client_party = None
    ...
    # Return the ID of the IBM Qiskit's Hybrid Node with Discrete Variables
    def get_hybrid_node_with_discrete_variables_id(self):
        return self.hybrid_node_with_discrete_variables_id

    # Return the Tag of the Type of the IBM Qiskit's Hybrid Node with Discrete Variables
    def get_hybrid_node_with_discrete_variables_type_tag(self):
        return self.hybrid_node_with_discrete_variables_type_tag

    # Return the Owner Client Party, using the IBM Qiskit's Hybrid Node with Discrete Variables
    def get_owner_client_party(self):
        return self.owner_client_party

    # Return the Boolean Flag, to keep the information about
    # the IBM Qiskit's Hybrid Node with Discrete Variables is currently being owned by some Client/Party
    def is_owned_by_client_party(self):
        return self.owned_by_client_party

    # Return the Memory Hardware Module of the IBM Qiskit's Hybrid Node with Discrete Variables
    def get_memory_hardware_module(self):
        return self.memory_hardware_module

    # Return the Communication Hardware Interface of the IBM Qiskit's Hybrid Node with Discrete Variables
    ...
    def print_info(self):
        ...
        # Print the Heading, with the ID of the IBM Qiskit's Hybrid Node, with Discrete Variables
        print("  Node #{}:\n".format(self.hybrid_node_with_discrete_variables_id))

        # Print the Sub-Heading, for the Owner Client/Party
        print("   - Owner Client/Party:")

        # If the IBM Qiskit's Hybrid Node, with Discrete Variables, is owned by some Client/Party
        ...
        # If the IBM Qiskit's Hybrid Node, with Discrete Variables, is not owned by some Client/Party
        else:
        ...
        # Print the Tag of the Type of the IBM Qiskit's Hybrid Node, with Discrete Variables
        print("   - Node's Type Tag: {};".format(self.hybrid_node_with_discrete_variables_type_tag))
