...
# Class of the IBM Qiskit's Semi-Quantum Node, with Discrete Variables
class QiskitSemiQuantumNodeWithDiscreteVariables:

    # Constructor of the IBM Qiskit's Semi-Quantum Node, with Discrete Variables
    def __init__(self, semi_quantum_node_with_discrete_variables_id):
        ...
        # The Data/Information Bus Module of the IBM Qiskit's Semi-Quantum Node, for Discrete Variables
    ...
    def attach_owner_client_party(self, owner_client_party):
        ...
        # with Discrete Variables, as the one given by argument
    ...
    def release_owner_client_party(self):
        ...
        # Set the Owner Client Party of the IBM Qiskit's Semi-Quantum Node,
        # with Discrete Variables, as None
        self.owner_client_party = None
    ...
    # Print the information about the IBM Qiskit's Semi-Quantum Node, with Discrete Variables
    def print_info(self):
        ...
        # Print the Heading, with the ID of the IBM Qiskit's Semi-Quantum Node, with Discrete Variables
        print("  Node #{}:\n".format(self.semi_quantum_node_with_discrete_variables_id))

        # Print the Sub-Heading, for the Owner Client/Party
        print("   - Owner Client/Party:")

        # If the IBM Qiskit's Semi-Quantum Node, with Discrete Variables, is owned by some Client/Party
        ...
        # If the IBM Qiskit's Semi-Quantum Node, with Discrete Variables, is not owned by some Client/Party
        else:
