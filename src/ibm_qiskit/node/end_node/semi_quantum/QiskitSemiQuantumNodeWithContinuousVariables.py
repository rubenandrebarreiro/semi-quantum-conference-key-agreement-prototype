...
# Class of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
class QiskitSemiQuantumNodeWithContinuousVariables:

    # Constructor of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
    def __init__(self, semi_quantum_node_with_continuous_variables_id):

        # The ID of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
        self.semi_quantum_node_with_continuous_variables_id = \
            semi_quantum_node_with_continuous_variables_id

        # The Tag of the Type of the IBM Qiskit's Semi-Quantum Node,
        # with Continuous Variables
        self.semi_quantum_node_with_continuous_variables_type_tag = \
            NodeTypes.SEMI_QUANTUM_NODE_CONTINUOUS_VARIABLES_ENUM
        ...
        # the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
        # is currently being owned by some Client/Party
        ...
        # The Data/Information Bus Module of the IBM Qiskit's Semi-Quantum Node, for Continuous Variables
    ...
    # Attach some Owner Client Party to the IBM Qiskit's Semi-Quantum Node,
    # with Continuous Variables
    def attach_owner_client_party(self, owner_client_party):

        # Set the Owner Client Party of the IBM Qiskit's Semi-Quantum Node,
        # with Continuous Variables, as the one given by argument
    ...
    def release_owner_client_party(self):
        ...
        # Set the Owner Client Party of the IBM Qiskit's Semi-Quantum Node,
        # with Continuous Variables, as None
        self.owner_client_party = None
    ...
    # Return the ID of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
    def get_semi_quantum_node_with_continuous_variables_id(self):
        return self.semi_quantum_node_with_continuous_variables_id

    # Return the Tag of the Type of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
    def get_semi_quantum_node_with_continuous_variables_type_tag(self):
        return self.semi_quantum_node_with_continuous_variables_type_tag
    ...
    # Return the Memory Hardware Module of the IBM Qiskit's Semi-Quantum Node,
    # with Continuous Variables
    ...
    # Print the information about the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
    def print_info(self):
        ...
        # Print the Heading, with the ID of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
        print("  Node #{}:\n".format(self.semi_quantum_node_with_continuous_variables_id))

        # Print the Sub-Heading, for the Owner Client/Party
        print("   - Owner Client/Party:")

        # If the IBM Qiskit's Semi-Quantum Node, with Continuous Variables, is owned by some Client/Party
        ...
        # If the IBM Qiskit's Semi-Quantum Node, with Continuous Variables, is not owned by some Client/Party
        else:
        ...
        # Print the Tag of the Type of the IBM Qiskit's Semi-Quantum Node, with Continuous Variables
        print("   - Node's Type Tag: {};".format(self.get_semi_quantum_node_with_continuous_variables_type_tag()))
